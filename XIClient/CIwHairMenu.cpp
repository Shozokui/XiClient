...
FFXI::CTk::CIwHairMenu::CIwHairMenu()
{
	this->field_1C = 0;
	this->field_18 = 0;
	this->field_14 = 0;
...
void FFXI::CTk::CIwHairMenu::OnInitialUpdatePrimitive()
{
...
void FFXI::CTk::CIwHairMenu::OnDrawPrimitive()
{
	//nullsub
}

void FFXI::CTk::CIwHairMenu::OnUpdatePrimitive()
{
	this->MenuCtrlData->field_4C = (this->field_14 & 0xFF) + 1;
	this->MenuCtrlData->RepositionCursol(this->MenuCtrlData->field_4C);
}

void FFXI::CTk::CIwHairMenu::OnKeyDown(short a2, short a3)
{
	if (this->field_1C == 1) {
